...
public class UsernameMissingLetter {

    public static void main(String[] args) throws InterruptedException {

        // Pokriti sve negativne case-eve za login na sajt https://practicetestautomation.com/
        // (Napraviti posebnu klasu za svaki case gde ne prolazi log-in)
