...
public class Selenium10D {

   /* WebDriver driver;      // OVAJ ZADATAK ZA VIKEND SAMOSTALNO URADITI
    ...
    public void goToLoginPage(){                   // MOZEMO DEFINISATI METODU SAMOSTALNO IZVAN ANOTACIJA.
                                                  // PA JE POZIVATI UNUTAR METODA S ANOTACIJAMA
    ...
    public void userCannotLogInWithInvalidUsername() {
        ...
        Assert.assertEquals(errorNotification.getText(), expectedNotification);  //WAITER
